...
Nous souhaitons ainsi offrir à nos utilisateur un service plus complet que ceux existant actuellement. Une application qui leur permet de gérer leurs surplus, mais également d'aider à la récolte même, un élément souvent oublié lorsque l'on parle de gaspillage.
...
\begin{tabular}{|p{3.5cm}|p {3.5cm}|c|c|c|} \hline
    ...
    Accéder à l'ensemble des informations via une carte interactice & Permettre à l'utilisateur de s'y retrouver facilement & Moyen & Moyen \\ \hline
...
Aujourd'hui, les circuits courts sont les alternatives les plus intéressantes face au défi qu'est devenu la gestion de l'alimentation et de l'eau. De nombreuses solutions sont apparues pour faire face à ce défi. Parmi  sont les jardins partagées, micro-fermes mais également le partage de ressources produites au sein de jardins privés. 

Ces applications sont principalement utilisées par les propriétaires de jardin privées. Chacune d'entre elle permet de répondre à sa manière à la problématique du surplus de production dans ces jardins ainsi que leur gestion.
